...
const zh = {
  ...
  'auth.signOut': '退出登录',
  'auth.loading': '请稍候...',
  'auth.remaining': '免费额度：{{remaining}} / {{limit}} 次',
  'auth.loginRequired': '请先登录后继续',
  'auth.noQuota': '免费额度已用完，请稍后再试',
...
const en: TranslationRecord = {
  ...
  'auth.remaining': 'Free quota: {{remaining}} / {{limit}} runs',
  'auth.loginRequired': 'Please sign in to continue',
  'auth.noQuota': 'Free quota has been used up. Please try again later.',
